...
public class CookieClickerRunner 
{

    int FPS = 60;   //Frames per second (animation speed)
    AnimationPanel world = new CookieClickerEngine();
    ...
    {
        CookieClickerRunner runner = new CookieClickerRunner();
    }    
